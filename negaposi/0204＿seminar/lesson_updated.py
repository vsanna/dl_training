...
# 6. 精度向上
# - 学習データのデータセットは変えず、そのデータを例えば10分割する
# - そのうち1つをテストデータとし、10回検証し(cross validation)てf-1 scoreの平均値をだす
# - この作業をCやkernelを変更するたびに行い、適切なCやkernelを探し出す
# - option
#    - カーネルやコストを操作する
#        - Cは貪欲さ。どの程度分けるか。
#    - Bi-Gramの導入
# - 日本語の場合
#   - 助詞を残すか否か、名刺だけにするか、動詞だけにするか、どれもOK
#   - それぞれ全て素性選択になる
